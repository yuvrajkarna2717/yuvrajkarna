            ...
            <div className="space-y-4 my-8">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700">
                  ...
                  management efficiency and reducing codebase size by 600+
                  lines, increasing maintainability and performance.
                </p>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-700">
                  Boosted website performance by 20% through advanced
                  techniques, including lazy loading, minimizing re-renders, and
                  leveraging SWR for caching.
                </p>
              </div>
