      ...
      <section className="min-h-screen flex items-center justify-center px-6 py-24">
        <div className="max-w-2xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg text-gray-500 dark:text-gray-400 leading-relaxed max-w-lg mx-auto">
            A personal account of late nights, stubborn bugs, and the quiet
            satisfaction of shipping something real. Told honestly, without
            polish.
          </p>
      ...
      <div className="max-w-2xl mx-auto px-6 pb-32 space-y-0">
        ...
        <section id="chapter-1" className="pt-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            There's a version of this story that starts with a dramatic midnight
            epiphany. Mine was less cinematic. I was watching a tutorial, typed{" "}
            <code className="text-sm bg-gray-100 dark:bg-white/10 px-1.5 py-0.5 rounded font-mono">
              console.log("Hello")
            </code>
            , and something changed. Not in the code — in me. I felt the machine
            do exactly what I told it to. No ambiguity, no negotiation. Just
            logic.
          </p>
          ...
          <blockquote className="border-l-4 border-black dark:border-white pl-5 my-8 text-xl font-light italic text-gray-700 dark:text-gray-300 leading-relaxed">
            "That feeling of making something out of nothing — I've been chasing
            it ever since."
          </blockquote>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            I spent the next weeks taking apart websites in DevTools. Every time
            I changed a style or removed an element, a little dopamine hit. I
            wasn't building anything useful. I was just exploring. But that
            curiosity — unstructured and obsessive — laid the foundation for
            everything that followed.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            HTML turned into CSS turned into JavaScript turned into "okay, what
            else is there?" The answer, it turned out, was everything.
          </p>
        </section>
        ...
        <section id="chapter-2">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            I opened LeetCode for the first time expecting it to be like the
            tutorials — a walkthrough with a happy ending. Problem #1: Two Sum.
            Easy difficulty. I sat with it for forty minutes. Eventually I got
            it. Then I tried something medium, and I didn't get it for two days.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            That was the beginning of a long, slow rewiring of how my brain
            works. Two pointers. Sliding windows. Recursion. Dynamic programming
            — which felt like dark magic until, one afternoon, it didn't.
            Patterns started appearing where there were only problems before.
          </p>
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            I failed a lot. I still do. But I learned to sit with the discomfort
            of not knowing instead of immediately Googling the answer. That
            patience — or stubbornness, depending on who you ask — is probably
            the most useful skill I've built.
          </p>
        </section>
        ...
        <section id="chapter-3">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            Solving problems is one thing. Understanding <em>why</em> the
            solution works is another. GeeksforGeeks became my off-campus
            university. Trees, graphs, heaps, hashing — reading the theory
            behind the patterns I was learning on LeetCode made everything click
            differently.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            Computer science has history. Algorithms have inventors. There's a
            reason quicksort is taught in every first-year course and it's not
            arbitrary. Learning <em>that</em>
            history made me care about the craft in a different way — not just
            "does it pass?" but "is this the right approach?"
          </p>
          ...
          <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5 p-6 mb-8">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
              Data structures, algorithms, OS, DBMS, system design — built the
              CS fundamentals that I still reach for in every technical
              conversation.
            </p>
            <div className="mt-4">
              <a
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Theory without practice becomes trivia fast. But practice without
            theory becomes brittle. The combination — solving problems while
            understanding the science underneath — is what I kept coming back
            to.
          </p>
        </section>
        ...
        <section id="chapter-4">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            At some point, problem-solving in isolation stopped being enough. I
            needed to make things. Real things. Things other people could use.
            GitHub went from a place I'd heard about to the place where ideas
            went to become software.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            My first few repos were embarrassing. Copy-pasted tutorials with
            minor modifications. But then I built something that actually worked
            — a project I was proud enough to show people. The commit history
            tells the story of someone figuring it out in public, one push at a
            time.
          </p>
          ...
          <blockquote className="border-l-4 border-black dark:border-white pl-5 my-8 text-xl font-light italic text-gray-700 dark:text-gray-300 leading-relaxed">
            "Open source taught me that code is a conversation, not a
            monologue."
          </blockquote>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            Someone opened an issue on one of my libraries from a company I'd
            never heard of. They were using it in production. That message
            shifted something. I started writing code like it mattered — because
            someone, somewhere, might actually read it.
          </p>
        </section>
        ...
        <section id="chapter-5">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
            This story doesn't have an ending because it isn't finished. Every
            skill I've built has revealed five more I don't have yet. Every
            project I've shipped has generated ideas for the next one. The
            horizon keeps moving, and I've made peace with that.
          </p>

          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
            The developer I am today would genuinely impress the person who
            first typed that{" "}
            <code className="text-sm bg-gray-100 dark:bg-white/10 px-1.5 py-0.5 rounded font-mono">
              console.log
            </code>
            . But I'm still that same person — curious, stubborn, and convinced
            that the next thing I build will be the most interesting thing I've
            ever made.
          </p>

          <blockquote className="border-l-4 border-black dark:border-white pl-5 my-8 text-xl font-light italic text-gray-700 dark:text-gray-300 leading-relaxed">
            "I'm still asking 'how does this work?' — just with better tools to
            find out."
          </blockquote>
        </section>
        ...
        <section id="contact" className="py-8 text-center space-y-6">
          ...
          <p className="text-gray-500 dark:text-gray-400 leading-relaxed max-w-md mx-auto">
            ...
            interesting problem — my inbox is open.
          </p>
