      ...
      <div className="p-8">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {project.techStack.map((tech, idx) => (
            <div key={idx} className="flex items-center bg-gray-50 hover:bg-gray-100 px-3 py-2 rounded-lg transition-colors">
              {getIconByTech(tech) && (
                <div className="w-4 h-4 mr-2 text-gray-700">
                  {getIconByTech(tech)}
                </div>
              )}
        ...
        {expanded && (
          <div className="space-y-3 text-gray-600 text-sm mb-6 pl-4 border-l-2 border-blue-200 animate-fadeIn">
...
export default function Project() {
  ...
  const projects: Project[] = [
    {
      title: "iQua.ai",
      description: "A cutting-edge AI-powered platform revolutionizing data analytics and business intelligence with real-time insights and automated reporting.",
      techStack: ["React.js", "TypeScript", "TailwindCSS"],
      highlights: [
        "Built the complete frontend architecture from scratch using React.js and TypeScript",
        "Implemented responsive design with TailwindCSS ensuring seamless user experience across devices",
        "Integrated complex data visualization components for real-time analytics dashboard",
        "Optimized performance resulting in 40% faster load times and improved user engagement",
        "Collaborated with backend team to implement RESTful API integrations"
      ],
      live: "https://iqua.ai",
      category: "frontend",
      status: "completed",
      users: "Thousands of daily users"
    },
    {
      title: "PNN",
      description: "A comprehensive news platform MVP delivering personalized content with advanced filtering and real-time updates for enhanced user engagement.",
      techStack: ["React.js", "JavaScript", "CSS3"],
      highlights: [
        "Led complete frontend development from concept to deployment as sole frontend developer",
        "Designed and implemented user-friendly interface with advanced search and filtering capabilities",
        "Built responsive news feed with infinite scroll and real-time content updates",
        "Implemented user authentication and personalization features",
        "Created modular component architecture for scalable development"
      ],
      github: "https://github.com/yuvrajkarna/pnn",
      live: "https://pnn-demo.com",
      category: "frontend",
      status: "completed"
    },
    {
      title: "Dhanvv.ai",
      description: "An innovative AI-driven financial platform providing intelligent investment insights and automated portfolio management solutions.",
      techStack: ["React.js", "Node.js", "MongoDB", "OpenAI", "Express.js"],
      highlights: [
        "Currently developing full-stack application with AI integration using OpenAI APIs",
        "Building robust backend architecture with Node.js and Express.js for scalable performance",
        "Implementing MongoDB database design for efficient data storage and retrieval",
        "Creating intelligent chatbot interface for financial advisory services",
        "Developing real-time portfolio tracking and analytics dashboard"
      ],
      github: "https://github.com/yuvrajkarna/dhanvv-ai",
      category: "fullstack",
      status: "development"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Showcasing my professional work and contributions across different technologies and domains
          </p>
        </div>
